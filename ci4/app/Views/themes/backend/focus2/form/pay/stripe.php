                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" required="required" name="amount" id="amount" class="form-control" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
    ...
    function createToken() {
        ...
        if(document.getElementById("amount").value >= 100) {
            if(document.getElementById("amount").value <= 10000) {
                ...
                document.getElementById("pay-btn").disabled = false;
                alert("Amount must be less than $10,000 or equals");
            }
        }else{
            document.getElementById("pay-btn").disabled = false;
            alert("Amount must be greater than $100 or equals");
        }
