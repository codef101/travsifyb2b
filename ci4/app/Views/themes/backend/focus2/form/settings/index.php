                                        ...
                                        <div id="v-pills-all" class="tab-pane fade active show">
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <label class="text-dark">Flight Api Rate(%)</label>
                                                            <input type="text" id="rate" name="rate" class="form-control" placeholder="Enter Rate" value="<?= (isset($obj)) ? $obj['rate'] : set_value('rate');?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <label class="text-dark">Stripe Secret key</label>
                                                            <input type="text" id="stripe_sk" name="stripe_sk" class="form-control" placeholder="Enter secret key here" value="<?= (isset($obj)) ? $obj['stripe_sk'] : set_value('stripe_sk');?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <label class="text-dark">Stripe Public key</label>
                                                            <input type="text" id="stripe_pk" name="stripe_pk" class="form-control" placeholder="Enter public key here" value="<?= (isset($obj)) ? $obj['stripe_pk'] : set_value('stripe_pk');?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <label class="text-dark">Fincra Secret key</label>
                                                            <input type="text" id="fincra_sk" name="fincra_sk" class="form-control" placeholder="Enter fincra secret key here" value="<?= (isset($obj)) ? $obj['fincra_sk'] : set_value('fincra_sk');?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <label class="text-dark">Fincra Public key</label>
                                                            <input type="text" id="fincra_pk" name="fincra_pk" class="form-control" placeholder="Enter fincra public key here" value="<?= (isset($obj)) ? $obj['fincra_pk'] : set_value('fincra_pk');?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
