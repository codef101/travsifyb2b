                        ...
                        <form class="form" action="<?=site_url("user/store")?>" method="post">
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="text-dark">User Balance (USD)</label>
                                            <input type="text" id="balance" name="balance" class="form-control" placeholder="Update user balance" value="<?= (isset($obj)) ? $obj['balance'] : set_value('balance');?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
