                        ...
                        <div class="col-lg-8 col-xxl-6">
                            <div class="text-center my-5">
                                ...
                                <p class="lead fw-normal text-muted mb-4">
                                    We are industry leaders in supplying, selling, and servicing air content (flights, ancillaries, bundles, brands) for the travel supply chain as well as hotel listings or stays. Travsify B2B has earned a reputation for applying the right mix of technology and innovative thought to create B2B solutions that deliver value and exceed customer expectations. As a result, Travsify is trusted by over 700 airlines, 1.5 million hotels globally and 3000+ travel sellers worldwide.
                                    <br>
                                ...
                                <a class="btn btn-primary btn-lg" href="/site/About">Get started</a>
                            </div>
                        </div>
                    </div>
                </div>
