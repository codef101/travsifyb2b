            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header row">
                        <div class="col-sm-6">
                            <h3 class="card-title">Pay Via Bank</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-sm-12">
                                <h5><strong>USD Account</strong></h5>
                                <h5><small>Bank Name:</small> UBA</h5>
                                <h5><small>Account Number:</small> 3004241794</h5>
                                <h5><small>Account Name:</small> Travsify Global</h5>
                            </div>
                        </div>
                        <br>
                        <div class="row">
