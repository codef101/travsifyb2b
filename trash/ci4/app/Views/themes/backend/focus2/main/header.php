...
$role = session()->get('dashboard');
$moder = session()->get('mode');
?>
<!DOCTYPE html>
                        ...
                        <?php if($role == "user"){ ?>
                            <li class="nav-item dropdown header-profile">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" id="env" name="env" class="custom-control-input">
                                    <label for="env" class="custom-control-label"><?=getDictionary('Test Mode')?></label>
                                </div>
                            </li>
                        <?php } ?>
