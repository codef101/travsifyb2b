...
$writeable_directories = array(
    'cache' => '/ci4/writable/cache',
    'debugbar' => '/ci4/writable/debugbar',
    'logs' => '/ci4/writable/logs',
    'session' => '/ci4/writable/session',
    'uploads' => '/ci4/writable/uploads',
    'uploads' => '/ci4/app/Modules',
    'env' => '/ci4/.env',
    'files' => '/assets/img',
    'routes' => '/index.php'
);
