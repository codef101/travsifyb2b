                            ...
                            <form name="config-form" id="config-form" action="process.php" method="post">
                                ...
                                <div class="section clearfix">
                                    ...
                                    <div>
                                        <div class="form-group clearfix">
                                            <div class="row">
                                                <label for="purchase_code" class=" col-md-3">Item purchase code | <a href="https://cutt.ly/PLFZenO" target="_blank">NULLED :: Web Community</a></label>
                                                <div class="col-md-9">
                                                    <input type="text" value=""  id="purchase_code"  name="purchase_code" class="form-control"  placeholder="random value" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
